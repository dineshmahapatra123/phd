...
1.  **Sources (`sources/`)**: Immutable, machine-readable full-text. Zero edits allowed.
2.  **Wiki (`Concepts/`, `People/`, `Methods/`)**: Atomic articles shattered from sources. AI-managed, human-guided.
...
Standard metadata for every wiki page:
```yaml
