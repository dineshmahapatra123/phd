...
## Standard Definition
The **Record-Reality Gap** is the chronic divergence between the official land records maintained by the state and the actual ground-level facts of land ownership and possession. It describes a condition where the register does not reflect who actually owns or occupies a parcel of land.

## Mechanism of Production
The gap is produced by **mutation lag** — the failure to update land records when ownership changes hands. In India:
- Transfers are registered as deeds (documents) but the mutation of the revenue record is a separate, discretionary administrative act.
- Parties frequently do not initiate mutation (to avoid scrutiny, higher taxes, or bureaucratic cost).
- Revenue officials do not proactively update records from registration memoranda.
- The result: a chain of private transactions floats free from the official record.

## Empirical Scale (India)
Wadhwa (2002) documents:
- Millions of cases of mutation and measurement pending across the country.
- In one Andhra Pradesh district: 49.5% of Field Measurement Books were missing or torn.
- In Madhya Pradesh (1988): 23 of 28 allottees of government land were not in possession of land allotted to them.
- In Pune (computerised records): approximately 70% of Property Cards contain incorrect entries.
- The ITDC operated 32 hotels for up to 45 years without a single property having title deeds in order.

## Consequences
- **Litigation proliferation**: Every working day, hundreds of thousands wait in courts over land disputes. V.R. Krishna Iyer: "Land litigation has crowded civil courts."
- **Credit exclusion**: Lending institutions require authentic title before extending credit. Patta passbooks — based on presumptive records — are rejected as collateral.
- **Land reform failure**: The absence of reliable records is the principal reason land reforms legislation has not been implemented.
- **Encroachment**: Public land with no reliable record-holder is vulnerable to private encroachment.
