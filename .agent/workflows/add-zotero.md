...
2. **Find the PDF (Optional):** If the user specifies the item is in the `7 - Raw/` folder, search that folder for the corresponding PDF.
3. **Get API Details:** Read `/Users/dineshmahapatra/Library/CloudStorage/GoogleDrive-dineshmahapatra123@gmail.com/My Drive/PhD/1 - Rough/Handy notes/HN_01.md` for Zotero credentials. Never print API keys or tokens.
