...
cp ~/.antigravity/skills/notebooklm/data/library.json library.backup.json

# Reset library
rm ~/.antigravity/skills/notebooklm/data/library.json
...
```bash
# Check disk usage
df -h ~/.antigravity/skills/notebooklm/data/
...
if [ -f ~/.antigravity/skills/notebooklm/data/library.json ]; then
    cp ~/.antigravity/skills/notebooklm/data/library.json ~/library.backup.json
fi
...
if [ -f ~/library.backup.json ]; then
    mkdir -p ~/.antigravity/skills/notebooklm/data/
    cp ~/library.backup.json ~/.antigravity/skills/notebooklm/data/library.json
fi
```
...
ls -la ~/.antigravity/skills/notebooklm/data/
```

### Common questions

**Q: Why doesn't this work in Antigravity web UI?**
A: Web UI has no network access. Use local Antigravity.
